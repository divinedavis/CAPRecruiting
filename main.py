...
COLLEGES_BY_STATE = [
    # FBS (133 schools)
    ("Air Force", "CO", "FBS"), ("Akron", "OH", "FBS"), ("Alabama", "AL", "FBS"),
    ("Appalachian State", "NC", "FBS"), ("Arizona", "AZ", "FBS"), ("Arizona State", "AZ", "FBS"),
    ("Arkansas", "AR", "FBS"), ("Arkansas State", "AR", "FBS"), ("Army", "NY", "FBS"),
    ("Auburn", "AL", "FBS"), ("Ball State", "IN", "FBS"), ("Baylor", "TX", "FBS"),
    ("Boise State", "ID", "FBS"), ("Boston College", "MA", "FBS"), ("Bowling Green", "OH", "FBS"),
    ("Buffalo", "NY", "FBS"), ("BYU", "UT", "FBS"), ("California", "CA", "FBS"),
    ("Central Michigan", "MI", "FBS"), ("Charlotte", "NC", "FBS"), ("Cincinnati", "OH", "FBS"),
    ("Clemson", "SC", "FBS"), ("Coastal Carolina", "SC", "FBS"), ("Colorado", "CO", "FBS"),
    ("Colorado State", "CO", "FBS"), ("Delaware", "DE", "FBS"), ("Duke", "NC", "FBS"),
    ("East Carolina", "NC", "FBS"), ("Eastern Michigan", "MI", "FBS"), ("FIU", "FL", "FBS"),
    ("Florida", "FL", "FBS"), ("Florida Atlantic", "FL", "FBS"), ("Florida State", "FL", "FBS"),
    ("Fresno State", "CA", "FBS"), ("Georgia", "GA", "FBS"), ("Georgia Southern", "GA", "FBS"),
    ("Georgia State", "GA", "FBS"), ("Georgia Tech", "GA", "FBS"), ("Hawaii", "HI", "FBS"),
    ("Houston", "TX", "FBS"), ("Illinois", "IL", "FBS"), ("Indiana", "IN", "FBS"),
    ("Iowa", "IA", "FBS"), ("Iowa State", "IA", "FBS"), ("Jacksonville State", "AL", "FBS"),
    ("James Madison", "VA", "FBS"), ("Kansas", "KS", "FBS"), ("Kansas State", "KS", "FBS"),
    ("Kennesaw State", "GA", "FBS"), ("Kent State", "OH", "FBS"), ("Kentucky", "KY", "FBS"),
    ("Liberty", "VA", "FBS"), ("Louisiana", "LA", "FBS"), ("Louisiana Tech", "LA", "FBS"),
    ("Louisville", "KY", "FBS"), ("LSU", "LA", "FBS"), ("Marshall", "WV", "FBS"),
    ("Maryland", "MD", "FBS"), ("Memphis", "TN", "FBS"), ("Miami (FL)", "FL", "FBS"),
    ("Miami (OH)", "OH", "FBS"), ("Michigan", "MI", "FBS"), ("Michigan State", "MI", "FBS"),
    ("Middle Tennessee", "TN", "FBS"), ("Minnesota", "MN", "FBS"),
    ("Mississippi State", "MS", "FBS"), ("Missouri", "MO", "FBS"), ("Missouri State", "MO", "FBS"),
    ("Navy", "MD", "FBS"), ("NC State", "NC", "FBS"), ("Nebraska", "NE", "FBS"),
    ("Nevada", "NV", "FBS"), ("New Mexico", "NM", "FBS"), ("New Mexico State", "NM", "FBS"),
    ("North Carolina", "NC", "FBS"), ("North Dakota State", "ND", "FBS"),
    ("North Texas", "TX", "FBS"), ("Northern Illinois", "IL", "FBS"),
    ("Northwestern", "IL", "FBS"), ("Notre Dame", "IN", "FBS"), ("Ohio", "OH", "FBS"),
    ("Ohio State", "OH", "FBS"), ("Oklahoma", "OK", "FBS"), ("Oklahoma State", "OK", "FBS"),
    ("Old Dominion", "VA", "FBS"), ("Ole Miss", "MS", "FBS"), ("Oregon", "OR", "FBS"),
    ("Oregon State", "OR", "FBS"), ("Penn State", "PA", "FBS"), ("Pittsburgh", "PA", "FBS"),
    ("Purdue", "IN", "FBS"), ("Rice", "TX", "FBS"), ("Rutgers", "NJ", "FBS"),
    ("Sacramento State", "CA", "FBS"), ("Sam Houston", "TX", "FBS"),
    ("San Diego State", "CA", "FBS"), ("San Jose State", "CA", "FBS"), ("SMU", "TX", "FBS"),
    ("South Alabama", "AL", "FBS"), ("South Carolina", "SC", "FBS"),
    ("South Florida", "FL", "FBS"), ("Southern Miss", "MS", "FBS"), ("Stanford", "CA", "FBS"),
    ("Syracuse", "NY", "FBS"), ("TCU", "TX", "FBS"), ("Temple", "PA", "FBS"),
    ("Tennessee", "TN", "FBS"), ("Texas", "TX", "FBS"), ("Texas A&M", "TX", "FBS"),
    ("Texas State", "TX", "FBS"), ("Texas Tech", "TX", "FBS"), ("Toledo", "OH", "FBS"),
    ("Troy", "AL", "FBS"), ("Tulane", "LA", "FBS"), ("Tulsa", "OK", "FBS"),
    ("UAB", "AL", "FBS"), ("UCF", "FL", "FBS"), ("UCLA", "CA", "FBS"), ("UConn", "CT", "FBS"),
    ("ULM", "LA", "FBS"), ("UMass", "MA", "FBS"), ("UNLV", "NV", "FBS"), ("USC", "CA", "FBS"),
    ("Utah", "UT", "FBS"), ("Utah State", "UT", "FBS"), ("UTEP", "TX", "FBS"),
    ("UTSA", "TX", "FBS"), ("Vanderbilt", "TN", "FBS"), ("Virginia", "VA", "FBS"),
    ("Virginia Tech", "VA", "FBS"), ("Wake Forest", "NC", "FBS"), ("Washington", "WA", "FBS"),
    ("Washington State", "WA", "FBS"), ("West Virginia", "WV", "FBS"),
    ("Western Kentucky", "KY", "FBS"), ("Western Michigan", "MI", "FBS"),
    ("Wisconsin", "WI", "FBS"), ("Wyoming", "WY", "FBS"),
    # FCS (121 schools)
    ("Abilene Christian", "TX", "FCS"), ("Alabama A&M", "AL", "FCS"),
    ("Alabama State", "AL", "FCS"), ("Albany", "NY", "FCS"), ("Alcorn State", "MS", "FCS"),
    ("Arkansas-Pine Bluff", "AR", "FCS"), ("Austin Peay", "TN", "FCS"),
    ("Bethune-Cookman", "FL", "FCS"), ("Brown", "RI", "FCS"), ("Bryant", "RI", "FCS"),
    ("Bucknell", "PA", "FCS"), ("Butler", "IN", "FCS"), ("Cal Poly", "CA", "FCS"),
    ("Campbell", "NC", "FCS"), ("Central Arkansas", "AR", "FCS"),
    ("Central Connecticut", "CT", "FCS"), ("Charleston Southern", "SC", "FCS"),
    ("Chattanooga", "TN", "FCS"), ("The Citadel", "SC", "FCS"), ("Colgate", "NY", "FCS"),
    ("Columbia", "NY", "FCS"), ("Cornell", "NY", "FCS"), ("Dartmouth", "NH", "FCS"),
    ("Davidson", "NC", "FCS"), ("Dayton", "OH", "FCS"), ("Delaware State", "DE", "FCS"),
    ("Drake", "IA", "FCS"), ("Duquesne", "PA", "FCS"), ("East Tennessee State", "TN", "FCS"),
    ("East Texas A&M", "TX", "FCS"), ("Eastern Illinois", "IL", "FCS"),
    ("Eastern Kentucky", "KY", "FCS"), ("Eastern Washington", "WA", "FCS"), ("Elon", "NC", "FCS"),
    ("Florida A&M", "FL", "FCS"), ("Fordham", "NY", "FCS"), ("Furman", "SC", "FCS"),
    ("Gardner-Webb", "NC", "FCS"), ("Georgetown", "DC", "FCS"), ("Grambling State", "LA", "FCS"),
    ("Hampton", "VA", "FCS"), ("Harvard", "MA", "FCS"), ("Holy Cross", "MA", "FCS"),
    ("Houston Christian", "TX", "FCS"), ("Howard", "DC", "FCS"), ("Idaho", "ID", "FCS"),
    ("Idaho State", "ID", "FCS"), ("Illinois State", "IL", "FCS"),
    ("Incarnate Word", "TX", "FCS"), ("Indiana State", "IN", "FCS"),
    ("Jackson State", "MS", "FCS"), ("Lafayette", "PA", "FCS"), ("Lamar", "TX", "FCS"),
    ("Lehigh", "PA", "FCS"), ("Lindenwood", "MO", "FCS"), ("LIU", "NY", "FCS"),
    ("Maine", "ME", "FCS"), ("Marist", "NY", "FCS"), ("McNeese", "LA", "FCS"),
    ("Mercer", "GA", "FCS"), ("Merrimack", "MA", "FCS"),
    ("Mississippi Valley State", "MS", "FCS"), ("Monmouth", "NJ", "FCS"),
    ("Montana", "MT", "FCS"), ("Montana State", "MT", "FCS"),
    ("Morehead State", "KY", "FCS"), ("Morgan State", "MD", "FCS"),
    ("Murray State", "KY", "FCS"), ("New Hampshire", "NH", "FCS"), ("Nicholls", "LA", "FCS"),
    ("Norfolk State", "VA", "FCS"), ("North Alabama", "AL", "FCS"),
    ("North Carolina A&T", "NC", "FCS"), ("North Carolina Central", "NC", "FCS"),
    ("North Dakota", "ND", "FCS"), ("Northern Arizona", "AZ", "FCS"),
    ("Northern Colorado", "CO", "FCS"), ("Northern Iowa", "IA", "FCS"),
    ("Northwestern State", "LA", "FCS"), ("Penn", "PA", "FCS"), ("Portland State", "OR", "FCS"),
    ("Prairie View A&M", "TX", "FCS"), ("Presbyterian", "SC", "FCS"),
    ("Princeton", "NJ", "FCS"), ("Rhode Island", "RI", "FCS"), ("Richmond", "VA", "FCS"),
    ("Robert Morris", "PA", "FCS"), ("Sacred Heart", "CT", "FCS"),
    ("Saint Francis (PA)", "PA", "FCS"), ("St. Thomas", "MN", "FCS"), ("Samford", "AL", "FCS"),
    ("San Diego", "CA", "FCS"), ("South Carolina State", "SC", "FCS"),
    ("South Dakota", "SD", "FCS"), ("South Dakota State", "SD", "FCS"),
    ("Southeast Missouri State", "MO", "FCS"), ("Southeastern Louisiana", "LA", "FCS"),
    ("Southern", "LA", "FCS"), ("Southern Illinois", "IL", "FCS"),
    ("Southern Utah", "UT", "FCS"), ("Stephen F. Austin", "TX", "FCS"),
    ("Stetson", "FL", "FCS"), ("Stonehill", "MA", "FCS"), ("Stony Brook", "NY", "FCS"),
    ("Tarleton State", "TX", "FCS"), ("Tennessee State", "TN", "FCS"),
    ("Tennessee Tech", "TN", "FCS"), ("Texas Southern", "TX", "FCS"), ("Towson", "MD", "FCS"),
    ("UC Davis", "CA", "FCS"), ("UT Martin", "TN", "FCS"), ("Utah Tech", "UT", "FCS"),
    ("UTRGV", "TX", "FCS"), ("Valparaiso", "IN", "FCS"), ("Villanova", "PA", "FCS"),
    ("VMI", "VA", "FCS"), ("Wagner", "NY", "FCS"), ("Weber State", "UT", "FCS"),
    ("Western Carolina", "NC", "FCS"), ("Western Illinois", "IL", "FCS"),
    ("William & Mary", "VA", "FCS"), ("Wofford", "SC", "FCS"), ("Yale", "CT", "FCS"),
    ("Youngstown State", "OH", "FCS"),
    # D2 (145 schools)
    ("Adams State", "CO", "D2"), ("Albany State", "GA", "D2"), ("Allen", "SC", "D2"),
    ("American International", "MA", "D2"), ("Anderson (SC)", "SC", "D2"),
    ("Angelo State", "TX", "D2"), ("Arkansas Tech", "AR", "D2"),
    ("Arkansas-Monticello", "AR", "D2"), ("Ashland", "OH", "D2"), ("Assumption", "MA", "D2"),
    ("Augustana (SD)", "SD", "D2"), ("Barton", "NC", "D2"), ("Bemidji State", "MN", "D2"),
    ("Benedict", "SC", "D2"), ("Bentley", "MA", "D2"), ("Black Hills State", "SD", "D2"),
    ("Bloomsburg", "PA", "D2"), ("Bluefield State", "WV", "D2"), ("Bowie State", "MD", "D2"),
    ("California (PA)", "PA", "D2"), ("Carson-Newman", "TN", "D2"), ("Catawba", "NC", "D2"),
    ("Central Missouri", "MO", "D2"), ("Central Oklahoma", "OK", "D2"),
    ("Central State", "OH", "D2"), ("Central Washington", "WA", "D2"),
    ("Chadron State", "NE", "D2"), ("Charleston (WV)", "WV", "D2"), ("Chowan", "NC", "D2"),
    ("Clarion", "PA", "D2"), ("Clark Atlanta", "GA", "D2"), ("Colorado Mesa", "CO", "D2"),
    ("Colorado Mines", "CO", "D2"), ("Concord", "WV", "D2"), ("Concordia-St. Paul", "MN", "D2"),
    ("CSU Pueblo", "CO", "D2"), ("Davenport", "MI", "D2"), ("Delta State", "MS", "D2"),
    ("East Central", "OK", "D2"), ("East Stroudsburg", "PA", "D2"),
    ("Eastern New Mexico", "NM", "D2"), ("Edinboro", "PA", "D2"), ("Edward Waters", "FL", "D2"),
    ("Elizabeth City State", "NC", "D2"), ("Emory & Henry", "VA", "D2"),
    ("Emporia State", "KS", "D2"), ("Erskine", "SC", "D2"), ("Fairmont State", "WV", "D2"),
    ("Fayetteville State", "NC", "D2"), ("Ferris State", "MI", "D2"), ("Ferrum", "VA", "D2"),
    ("Findlay", "OH", "D2"), ("Fort Hays State", "KS", "D2"), ("Fort Lewis", "CO", "D2"),
    ("Fort Valley State", "GA", "D2"), ("Franklin Pierce", "NH", "D2"),
    ("Frostburg State", "MD", "D2"), ("Gannon", "PA", "D2"), ("Glenville State", "WV", "D2"),
    ("Grand Valley State", "MI", "D2"), ("Harding", "AR", "D2"),
    ("Henderson State", "AR", "D2"), ("Hillsdale", "MI", "D2"), ("Indianapolis", "IN", "D2"),
    ("IUP", "PA", "D2"), ("Johnson C. Smith", "NC", "D2"), ("Kentucky State", "KY", "D2"),
    ("Kentucky Wesleyan", "KY", "D2"), ("Kutztown", "PA", "D2"), ("Lake Erie", "OH", "D2"),
    ("Lane", "TN", "D2"), ("Lenoir-Rhyne", "NC", "D2"), ("Lincoln (MO)", "MO", "D2"),
    ("Lincoln (PA)", "PA", "D2"), ("Livingstone", "NC", "D2"), ("Lock Haven", "PA", "D2"),
    ("Mars Hill", "NC", "D2"), ("Mary", "ND", "D2"), ("McKendree", "IL", "D2"),
    ("Michigan Tech", "MI", "D2"), ("Midwestern State", "TX", "D2"), ("Miles", "AL", "D2"),
    ("Millersville", "PA", "D2"), ("Minnesota Duluth", "MN", "D2"),
    ("Minnesota State", "MN", "D2"), ("Minnesota State-Moorhead", "MN", "D2"),
    ("Minot State", "ND", "D2"), ("Missouri S&T", "MO", "D2"), ("Missouri Southern", "MO", "D2"),
    ("Missouri Western", "MO", "D2"), ("Morehouse", "GA", "D2"),
    ("Nebraska-Kearney", "NE", "D2"), ("New Mexico Highlands", "NM", "D2"),
    ("Newberry", "SC", "D2"), ("North Greenville", "SC", "D2"),
    ("Northeastern State", "OK", "D2"), ("Northern Michigan", "MI", "D2"),
    ("Northern State", "SD", "D2"), ("Northwest Missouri State", "MO", "D2"),
    ("Northwestern Oklahoma State", "OK", "D2"), ("Northwood", "MI", "D2"),
    ("Ohio Dominican", "OH", "D2"), ("Oklahoma Baptist", "OK", "D2"),
    ("Ouachita Baptist", "AR", "D2"), ("Pace", "NY", "D2"), ("Pittsburg State", "KS", "D2"),
    ("Post", "CT", "D2"), ("Quincy", "IL", "D2"), ("Roosevelt", "IL", "D2"),
    ("Saginaw Valley State", "MI", "D2"), ("Saint Anselm", "NH", "D2"),
    ("Savannah State", "GA", "D2"), ("Seton Hill", "PA", "D2"), ("Shaw", "NC", "D2"),
    ("Shepherd", "WV", "D2"), ("Shippensburg", "PA", "D2"), ("Shorter", "GA", "D2"),
    ("Sioux Falls", "SD", "D2"), ("Slippery Rock", "PA", "D2"),
    ("South Dakota Mines", "SD", "D2"), ("Southeastern Oklahoma State", "OK", "D2"),
    ("Southern Arkansas", "AR", "D2"), ("Southern Connecticut", "CT", "D2"),
    ("Southern Nazarene", "OK", "D2"), ("Southwest Baptist", "MO", "D2"),
    ("Southwest Minnesota State", "MN", "D2"), ("Southwestern Oklahoma State", "OK", "D2"),
    ("Sul Ross State", "TX", "D2"), ("Texas A&M-Kingsville", "TX", "D2"),
    ("Thomas More", "KY", "D2"), ("Tiffin", "OH", "D2"), ("Truman", "MO", "D2"),
    ("Tusculum", "TN", "D2"), ("Tuskegee", "AL", "D2"), ("UNC Pembroke", "NC", "D2"),
    ("Upper Iowa", "IA", "D2"), ("UT Permian Basin", "TX", "D2"), ("UVA Wise", "VA", "D2"),
    ("Valdosta State", "GA", "D2"), ("Virginia State", "VA", "D2"),
    ("Virginia Union", "VA", "D2"), ("Walsh", "OH", "D2"), ("Washburn", "KS", "D2"),
    ("Wayne State (MI)", "MI", "D2"), ("Wayne State (NE)", "NE", "D2"),
    ("West Alabama", "AL", "D2"), ("West Chester", "PA", "D2"), ("West Florida", "FL", "D2"),
    ("West Liberty", "WV", "D2"), ("West Texas A&M", "TX", "D2"),
    ("West Virginia State", "WV", "D2"), ("West Virginia Wesleyan", "WV", "D2"),
    ("Western Colorado", "CO", "D2"), ("Western New Mexico", "NM", "D2"),
    ("Western Oregon", "OR", "D2"), ("Wheeling", "WV", "D2"), ("William Jewell", "MO", "D2"),
    ("Wingate", "NC", "D2"),
    # D3 (~195 schools)
    ("Adrian", "MI", "D3"), ("Albion", "MI", "D3"), ("Albright", "PA", "D3"),
    ("Alfred", "NY", "D3"), ("Alfred State", "NY", "D3"), ("Allegheny", "PA", "D3"),
    ("Alma", "MI", "D3"), ("Alvernia", "PA", "D3"), ("Amherst", "MA", "D3"),
    ("Anderson (IN)", "IN", "D3"), ("Anna Maria", "MA", "D3"), ("Augsburg", "MN", "D3"),
    ("Augustana (IL)", "IL", "D3"), ("Aurora", "IL", "D3"), ("Austin College", "TX", "D3"),
    ("Averett", "VA", "D3"), ("Baldwin Wallace", "OH", "D3"), ("Bates", "ME", "D3"),
    ("Belhaven", "MS", "D3"), ("Beloit", "WI", "D3"), ("Benedictine (IL)", "IL", "D3"),
    ("Berry", "GA", "D3"), ("Bethany (WV)", "WV", "D3"), ("Bethel (MN)", "MN", "D3"),
    ("Bluffton", "OH", "D3"), ("Bowdoin", "ME", "D3"), ("Brevard", "NC", "D3"),
    ("Bridgewater (VA)", "VA", "D3"), ("Bridgewater State", "MA", "D3"),
    ("Brockport", "NY", "D3"), ("Buena Vista", "IA", "D3"), ("Buffalo State", "NY", "D3"),
    ("Cal Lutheran", "CA", "D3"), ("Calvin", "MI", "D3"), ("Capital", "OH", "D3"),
    ("Carleton", "MN", "D3"), ("Carnegie Mellon", "PA", "D3"), ("Carroll (WI)", "WI", "D3"),
    ("Carthage", "WI", "D3"), ("Case Western Reserve", "OH", "D3"), ("Catholic", "DC", "D3"),
    ("Centenary", "LA", "D3"), ("Central (IA)", "IA", "D3"), ("Centre", "KY", "D3"),
    ("Chapman", "CA", "D3"), ("Chicago", "IL", "D3"),
    ("Christopher Newport", "VA", "D3"), ("Claremont-Mudd-Scripps", "CA", "D3"),
    ("Coast Guard", "CT", "D3"), ("Coe", "IA", "D3"), ("Colby", "ME", "D3"),
    ("Concordia (IL)", "IL", "D3"), ("Concordia-Moorhead", "MN", "D3"),
    ("Concordia (WI)", "WI", "D3"), ("Cornell College", "IA", "D3"), ("Cortland", "NY", "D3"),
    ("Crown", "MN", "D3"), ("Curry", "MA", "D3"), ("Dean", "MA", "D3"),
    ("Delaware Valley", "PA", "D3"), ("Denison", "OH", "D3"), ("DePauw", "IN", "D3"),
    ("Dickinson", "PA", "D3"), ("Dubuque", "IA", "D3"),
    ("East Texas Baptist", "TX", "D3"), ("Eastern", "PA", "D3"),
    ("Elmhurst", "IL", "D3"), ("Endicott", "MA", "D3"), ("Eureka", "IL", "D3"),
    ("FDU-Florham", "NJ", "D3"), ("Fitchburg State", "MA", "D3"),
    ("Framingham State", "MA", "D3"), ("Franklin", "IN", "D3"),
    ("Franklin & Marshall", "PA", "D3"), ("Gallaudet", "DC", "D3"), ("Geneva", "PA", "D3"),
    ("George Fox", "OR", "D3"), ("Gettysburg", "PA", "D3"), ("Greensboro", "NC", "D3"),
    ("Greenville", "IL", "D3"), ("Grinnell", "IA", "D3"), ("Grove City", "PA", "D3"),
    ("Guilford", "NC", "D3"), ("Gustavus Adolphus", "MN", "D3"), ("Hamilton", "NY", "D3"),
    ("Hamline", "MN", "D3"), ("Hampden-Sydney", "VA", "D3"), ("Hanover", "IN", "D3"),
    ("Hardin-Simmons", "TX", "D3"), ("Hartwick", "NY", "D3"), ("Heidelberg", "OH", "D3"),
    ("Hendrix", "AR", "D3"), ("Hilbert", "NY", "D3"), ("Hiram", "OH", "D3"),
    ("Hobart", "NY", "D3"), ("Hope", "MI", "D3"), ("Howard Payne", "TX", "D3"),
    ("Huntingdon", "AL", "D3"), ("Husson", "ME", "D3"), ("Illinois College", "IL", "D3"),
    ("Illinois Wesleyan", "IL", "D3"), ("Ithaca", "NY", "D3"), ("John Carroll", "OH", "D3"),
    ("Johns Hopkins", "MD", "D3"), ("Juniata", "PA", "D3"), ("Kalamazoo", "MI", "D3"),
    ("Kean", "NJ", "D3"), ("Kenyon", "OH", "D3"), ("Keystone", "PA", "D3"),
    ("King's (PA)", "PA", "D3"), ("Knox", "IL", "D3"), ("La Verne", "CA", "D3"),
    ("LaGrange", "GA", "D3"), ("Lake Forest", "IL", "D3"), ("Lakeland", "WI", "D3"),
    ("Lawrence", "WI", "D3"), ("Lebanon Valley", "PA", "D3"), ("Lewis & Clark", "OR", "D3"),
    ("Linfield", "OR", "D3"), ("Loras", "IA", "D3"), ("Luther", "IA", "D3"),
    ("Lycoming", "PA", "D3"), ("Lyon", "AR", "D3"), ("Macalester", "MN", "D3"),
    ("Maine Maritime", "ME", "D3"), ("Manchester", "IN", "D3"), ("Marietta", "OH", "D3"),
    ("Martin Luther", "MN", "D3"), ("Mary Hardin-Baylor", "TX", "D3"),
    ("Maryville (TN)", "TN", "D3"), ("Mass. Maritime", "MA", "D3"), ("McDaniel", "MD", "D3"),
    ("McMurry", "TX", "D3"), ("Merchant Marine", "NY", "D3"), ("Methodist", "NC", "D3"),
    ("Middlebury", "VT", "D3"), ("Millikin", "IL", "D3"), ("Millsaps", "MS", "D3"),
    ("Minnesota-Morris", "MN", "D3"), ("Misericordia", "PA", "D3"), ("MIT", "MA", "D3"),
    ("Monmouth (IL)", "IL", "D3"), ("Montclair State", "NJ", "D3"), ("Moravian", "PA", "D3"),
    ("Morrisville State", "NY", "D3"), ("Mount St. Joseph", "OH", "D3"),
    ("Mount Union", "OH", "D3"), ("Muhlenberg", "PA", "D3"), ("Muskingum", "OH", "D3"),
    ("Nebraska Wesleyan", "NE", "D3"), ("New England College", "NH", "D3"),
    ("Nichols", "MA", "D3"), ("North Carolina Wesleyan", "NC", "D3"),
    ("North Central (IL)", "IL", "D3"), ("North Park", "IL", "D3"),
    ("Northwestern (MN)", "MN", "D3"), ("Norwich", "VT", "D3"), ("Oberlin", "OH", "D3"),
    ("Occidental", "CA", "D3"), ("Ohio Northern", "OH", "D3"), ("Ohio Wesleyan", "OH", "D3"),
    ("Olivet", "MI", "D3"), ("Otterbein", "OH", "D3"), ("Pacific (OR)", "OR", "D3"),
    ("Pacific Lutheran", "WA", "D3"), ("Plymouth State", "NH", "D3"),
    ("Pomona-Pitzer", "CA", "D3"), ("Puget Sound", "WA", "D3"),
    ("Randolph-Macon", "VA", "D3"), ("Redlands", "CA", "D3"), ("Rhodes", "TN", "D3"),
    ("Ripon", "WI", "D3"), ("Roanoke", "VA", "D3"), ("Rochester", "NY", "D3"),
    ("Rockford", "IL", "D3"), ("Rose-Hulman", "IN", "D3"), ("Rowan", "NJ", "D3"),
    ("RPI", "NY", "D3"), ("St. John Fisher", "NY", "D3"), ("St. John's (MN)", "MN", "D3"),
    ("St. Lawrence", "NY", "D3"), ("St. Norbert", "WI", "D3"), ("St. Olaf", "MN", "D3"),
    ("St. Scholastica", "MN", "D3"), ("St. Vincent", "PA", "D3"), ("Salisbury", "MD", "D3"),
    ("Salve Regina", "RI", "D3"), ("Sewanee", "TN", "D3"), ("Shenandoah", "VA", "D3"),
    ("Simpson (IA)", "IA", "D3"), ("Southern Virginia", "VA", "D3"),
    ("Southwestern (TX)", "TX", "D3"), ("Springfield", "MA", "D3"),
    ("Stevenson", "MD", "D3"), ("SUNY Maritime", "NY", "D3"), ("Susquehanna", "PA", "D3"),
    ("TCNJ", "NJ", "D3"), ("Texas Lutheran", "TX", "D3"), ("Thiel", "PA", "D3"),
    ("Trine", "IN", "D3"), ("Trinity (CT)", "CT", "D3"), ("Trinity (TX)", "TX", "D3"),
    ("Tufts", "MA", "D3"), ("UMass Dartmouth", "MA", "D3"), ("Union (NY)", "NY", "D3"),
    ("Ursinus", "PA", "D3"), ("Utica", "NY", "D3"),
    ("Vermont State Castleton", "VT", "D3"), ("Wabash", "IN", "D3"),
    ("Wartburg", "IA", "D3"), ("Washington & Jefferson", "PA", "D3"),
    ("Washington & Lee", "VA", "D3"), ("Washington University (MO)", "MO", "D3"),
    ("Waynesburg", "PA", "D3"), ("Wesleyan", "CT", "D3"), ("Western Connecticut", "CT", "D3"),
    ("Western New England", "MA", "D3"), ("Westfield State", "MA", "D3"),
    ("Westminster (PA)", "PA", "D3"), ("Wheaton (IL)", "IL", "D3"), ("Whitworth", "WA", "D3"),
    ("Widener", "PA", "D3"), ("Wilkes", "PA", "D3"), ("Willamette", "OR", "D3"),
    ("Williams", "MA", "D3"), ("Wilmington", "OH", "D3"),
    ("Wisconsin-Eau Claire", "WI", "D3"), ("Wisconsin-La Crosse", "WI", "D3"),
    ("Wisconsin-Oshkosh", "WI", "D3"), ("Wisconsin-Platteville", "WI", "D3"),
    ("Wisconsin-River Falls", "WI", "D3"), ("Wisconsin-Stevens Point", "WI", "D3"),
    ("Wisconsin-Stout", "WI", "D3"), ("Wisconsin-Whitewater", "WI", "D3"),
    ("Wittenberg", "OH", "D3"), ("Wooster", "OH", "D3"), ("Worcester Polytechnic", "MA", "D3"),
    ("Worcester State", "MA", "D3"),
    # NAIA (91 schools)
    ("Arizona Christian", "AZ", "NAIA"), ("Arkansas Baptist", "AR", "NAIA"),
    ("Ave Maria", "FL", "NAIA"), ("Avila", "MO", "NAIA"), ("Baker", "KS", "NAIA"),
    ("Benedictine (KS)", "KS", "NAIA"), ("Bethany (KS)", "KS", "NAIA"),
    ("Bethel (KS)", "KS", "NAIA"), ("Bethel (TN)", "TN", "NAIA"), ("Bluefield", "VA", "NAIA"),
    ("Briar Cliff", "IA", "NAIA"), ("Campbellsville", "KY", "NAIA"),
    ("Carroll (MT)", "MT", "NAIA"), ("Central Methodist", "MO", "NAIA"),
    ("Clarke", "IA", "NAIA"), ("College of Idaho", "ID", "NAIA"),
    ("Concordia (NE)", "NE", "NAIA"), ("Culver-Stockton", "MO", "NAIA"),
    ("Cumberland", "TN", "NAIA"), ("Cumberlands", "KY", "NAIA"),
    ("Dakota State", "SD", "NAIA"), ("Dakota Wesleyan", "SD", "NAIA"),
    ("Defiance", "OH", "NAIA"), ("Dickinson State", "ND", "NAIA"), ("Doane", "NE", "NAIA"),
    ("Dordt", "IA", "NAIA"), ("Eastern Oregon", "OR", "NAIA"), ("Evangel", "MO", "NAIA"),
    ("Faulkner", "AL", "NAIA"), ("Florida Memorial", "FL", "NAIA"), ("Friends", "KS", "NAIA"),
    ("Georgetown (KY)", "KY", "NAIA"), ("Graceland", "IA", "NAIA"),
    ("Grand View", "IA", "NAIA"), ("Hastings", "NE", "NAIA"),
    ("Indiana Wesleyan", "IN", "NAIA"), ("Judson", "IL", "NAIA"),
    ("Kansas Wesleyan", "KS", "NAIA"), ("Keiser", "FL", "NAIA"),
    ("Kentucky Christian", "KY", "NAIA"), ("Langston", "OK", "NAIA"),
    ("Lawrence Tech", "MI", "NAIA"), ("Lindsey Wilson", "KY", "NAIA"),
    ("Louisiana Christian", "LA", "NAIA"), ("Madonna", "MI", "NAIA"),
    ("Marian (IN)", "IN", "NAIA"), ("Mayville State", "ND", "NAIA"),
    ("McPherson", "KS", "NAIA"), ("MidAmerica Nazarene", "KS", "NAIA"),
    ("Midland", "NE", "NAIA"), ("Missouri Baptist", "MO", "NAIA"),
    ("Missouri Valley", "MO", "NAIA"), ("Montana State-Northern", "MT", "NAIA"),
    ("Montana Tech", "MT", "NAIA"), ("Montana Western", "MT", "NAIA"),
    ("Morningside", "IA", "NAIA"), ("Mount Marty", "SD", "NAIA"),
    ("Nelson", "TX", "NAIA"), ("Northwestern (IA)", "IA", "NAIA"),
    ("Oklahoma Panhandle State", "OK", "NAIA"), ("Olivet Nazarene", "IL", "NAIA"),
    ("Ottawa (AZ)", "AZ", "NAIA"), ("Ottawa (KS)", "KS", "NAIA"),
    ("Peru State", "NE", "NAIA"), ("Pikeville", "KY", "NAIA"), ("Point", "GA", "NAIA"),
    ("Reinhardt", "GA", "NAIA"), ("Rio Grande", "OH", "NAIA"),
    ("Rocky Mountain", "MT", "NAIA"), ("Saint Francis (IL)", "IL", "NAIA"),
    ("Saint Francis (IN)", "IN", "NAIA"), ("Saint Mary (KS)", "KS", "NAIA"),
    ("Saint Thomas (FL)", "FL", "NAIA"), ("Saint Xavier", "IL", "NAIA"),
    ("Siena Heights", "MI", "NAIA"), ("Simpson (CA)", "CA", "NAIA"),
    ("Southeastern (FL)", "FL", "NAIA"), ("Southern Oregon", "OR", "NAIA"),
    ("Southwestern (KS)", "KS", "NAIA"), ("St. Ambrose", "IA", "NAIA"),
    ("Sterling", "KS", "NAIA"), ("Tabor", "KS", "NAIA"), ("Taylor", "IN", "NAIA"),
    ("Texas College", "TX", "NAIA"), ("Texas Wesleyan", "TX", "NAIA"),
    ("Thomas (GA)", "GA", "NAIA"), ("Union (KY)", "KY", "NAIA"),
    ("Valley City State", "ND", "NAIA"), ("Waldorf", "IA", "NAIA"),
    ("Warner", "FL", "NAIA"), ("Wayland Baptist", "TX", "NAIA"),
    ("Webber International", "FL", "NAIA"), ("William Penn", "IA", "NAIA"),
    ("William Woods", "MO", "NAIA"),
    # NJCAA (non-CA) (~51 schools)
    ("ASA Miami", "FL", "JUCO"), ("Blinn", "TX", "JUCO"), ("Butler CC", "KS", "JUCO"),
    ("Central Lakes", "MN", "JUCO"), ("Cisco", "TX", "JUCO"), ("Coahoma CC", "MS", "JUCO"),
    ("Coffeyville CC", "KS", "JUCO"), ("College of DuPage", "IL", "JUCO"),
    ("Copiah-Lincoln CC", "MS", "JUCO"), ("Dodge City CC", "KS", "JUCO"),
    ("East Central CC", "MS", "JUCO"), ("East Mississippi CC", "MS", "JUCO"),
    ("Ellsworth CC", "IA", "JUCO"), ("Erie CC", "NY", "JUCO"),
    ("Fond du Lac", "MN", "JUCO"), ("Garden City CC", "KS", "JUCO"),
    ("Georgia Military", "GA", "JUCO"), ("Highland CC", "KS", "JUCO"),
    ("Hinds CC", "MS", "JUCO"), ("Hocking", "OH", "JUCO"), ("Holmes CC", "MS", "JUCO"),
    ("Hudson Valley CC", "NY", "JUCO"), ("Hutchinson CC", "KS", "JUCO"),
    ("Independence CC", "KS", "JUCO"), ("Iowa Central CC", "IA", "JUCO"),
    ("Iowa Western CC", "IA", "JUCO"), ("Itasca CC", "MN", "JUCO"),
    ("Itawamba CC", "MS", "JUCO"), ("Jones College", "MS", "JUCO"),
    ("Kilgore", "TX", "JUCO"), ("Lackawanna", "PA", "JUCO"), ("Louisburg", "NC", "JUCO"),
    ("Mesabi Range", "MN", "JUCO"), ("Minnesota State CTC", "MN", "JUCO"),
    ("Minnesota West CTC", "MN", "JUCO"), ("Mississippi Delta CC", "MS", "JUCO"),
    ("Mississippi Gulf Coast CC", "MS", "JUCO"), ("Monroe CC", "NY", "JUCO"),
    ("Nassau CC", "NY", "JUCO"), ("Navarro", "TX", "JUCO"),
    ("New Mexico Military", "NM", "JUCO"), ("North Dakota State CS", "ND", "JUCO"),
    ("Northeast Mississippi CC", "MS", "JUCO"), ("Northeastern Oklahoma A&M", "OK", "JUCO"),
    ("Northwest Mississippi CC", "MS", "JUCO"), ("Onondaga CC", "NY", "JUCO"),
    ("Pearl River CC", "MS", "JUCO"), ("Rochester CTC", "MN", "JUCO"),
    ("Snow", "UT", "JUCO"), ("Southwest Mississippi CC", "MS", "JUCO"),
    ("Trinity Valley CC", "TX", "JUCO"), ("Tyler JC", "TX", "JUCO"),
    ("Vermilion CC", "MN", "JUCO"),
    # CCCAA (California) (~67 schools)
    ("Allan Hancock", "CA", "JUCO"), ("American River", "CA", "JUCO"),
    ("Antelope Valley", "CA", "JUCO"), ("Bakersfield", "CA", "JUCO"),
    ("Butte", "CA", "JUCO"), ("Cabrillo", "CA", "JUCO"), ("Cerritos", "CA", "JUCO"),
    ("Chabot", "CA", "JUCO"), ("Chaffey", "CA", "JUCO"), ("Citrus", "CA", "JUCO"),
    ("City College of San Francisco", "CA", "JUCO"), ("College of San Mateo", "CA", "JUCO"),
    ("College of the Canyons", "CA", "JUCO"), ("College of the Desert", "CA", "JUCO"),
    ("College of the Redwoods", "CA", "JUCO"), ("College of the Sequoias", "CA", "JUCO"),
    ("Community Christian", "CA", "JUCO"), ("Compton", "CA", "JUCO"),
    ("Contra Costa", "CA", "JUCO"), ("De Anza", "CA", "JUCO"),
    ("Diablo Valley", "CA", "JUCO"), ("East Los Angeles", "CA", "JUCO"),
    ("El Camino", "CA", "JUCO"), ("Feather River", "CA", "JUCO"),
    ("Foothill", "CA", "JUCO"), ("Fresno City", "CA", "JUCO"),
    ("Fullerton", "CA", "JUCO"), ("Gavilan", "CA", "JUCO"),
    ("Glendale (CA)", "CA", "JUCO"), ("Golden West", "CA", "JUCO"),
    ("Grossmont", "CA", "JUCO"), ("Hartnell", "CA", "JUCO"),
    ("Laney", "CA", "JUCO"), ("Long Beach City", "CA", "JUCO"),
    ("Los Angeles Harbor", "CA", "JUCO"), ("Los Angeles Pierce", "CA", "JUCO"),
    ("Los Angeles Southwest", "CA", "JUCO"), ("Los Angeles Valley", "CA", "JUCO"),
    ("Los Medanos", "CA", "JUCO"), ("Merced", "CA", "JUCO"),
    ("Modesto", "CA", "JUCO"), ("Monterey Peninsula", "CA", "JUCO"),
    ("Moorpark", "CA", "JUCO"), ("Mt. San Antonio", "CA", "JUCO"),
    ("Mt. San Jacinto", "CA", "JUCO"), ("Orange Coast", "CA", "JUCO"),
    ("Palomar", "CA", "JUCO"), ("Pasadena City", "CA", "JUCO"),
    ("Reedley", "CA", "JUCO"), ("Riverside City", "CA", "JUCO"),
    ("Sacramento City", "CA", "JUCO"), ("Saddleback", "CA", "JUCO"),
    ("San Bernardino Valley", "CA", "JUCO"), ("San Diego Mesa", "CA", "JUCO"),
    ("San Joaquin Delta", "CA", "JUCO"), ("San Jose City", "CA", "JUCO"),
    ("Santa Ana", "CA", "JUCO"), ("Santa Barbara City", "CA", "JUCO"),
    ("Santa Monica", "CA", "JUCO"), ("Santa Rosa", "CA", "JUCO"),
    ("Shasta", "CA", "JUCO"), ("Sierra", "CA", "JUCO"),
    ("Southwestern (CA)", "CA", "JUCO"), ("Ventura", "CA", "JUCO"),
    ("Victor Valley", "CA", "JUCO"), ("West Hills Coalinga", "CA", "JUCO"),
