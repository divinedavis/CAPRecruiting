...
window.COLLEGE_DATA = {
    ...
    "D3": {
        ...
        "HCAC": ["Anderson","Bluffton","Defiance","Franklin","Hanover","Manchester","Mount St. Joseph","Rose-Hulman"],
        "Liberty League": ["Clarkson","Hobart","Ithaca","RPI","Rochester","Skidmore","St. Lawrence","Union (NY)","William Smith"],
        "MAC (D3)": ["Albright","Alvernia","Delaware Valley","DeSales","Eastern","FDU-Florham","King's","Lebanon Valley","Lycoming","Messiah","Misericordia","Stevenson","Widener","Wilkes"],
        "MIAA": ["Adrian","Albion","Alma","Calvin","Hope","Kalamazoo","Olivet","Trine"],
        "NCAC": ["Allegheny","Denison","DePauw","Hiram","Kenyon","Oberlin","Ohio Wesleyan","Wabash","Wittenberg","Wooster"],
        ...
        "PAC": ["Bethany","Chatham","Geneva","Grove City","Saint Vincent","Thiel","Washington & Jefferson","Waynesburg","Westminster (PA)"],
